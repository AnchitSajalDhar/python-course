...
#counter.
for index, val in enumerate([10, 20, 30],111):
    print(index,val)
...
list(map(lambda x: 'Perfect' if x >= 70 else 'Needs Improvement', marks))
 # concise way of transforming values
...
# fun1(a=10,c=20,d=10,b=45) # keyword notation
...
result = bar(1, 2, 3, action = "sum", number = "first",text ="spfyf")
...
myFunction(1, 2, 3, 4, 5, '6', 7, name='Mandar', country='India', age=25,20)
